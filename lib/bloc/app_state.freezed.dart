...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AppLifecycleState? appLifecycleState});
}
...
class _$AppStateCopyWithImpl<$Res, $Val extends AppState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      appLifecycleState: freezed == appLifecycleState
...
class _$_AppState implements _AppState {
  const _$_AppState({this.appLifecycleState});
  ...
  @override
  String toString() {
    return 'AppState(appLifecycleState: $appLifecycleState)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, appLifecycleState);
...
abstract class _AppState implements AppState {
  const factory _AppState({final AppLifecycleState? appLifecycleState}) =
      _$_AppState;
